...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','SGDStepSize','RetryMaxFunEvals','SearchAcqFcn','ProposalFcn',...
    ...
    'ActiveVariationalSamples','ScaleLowerBound','ActiveSampleFullUpdate','GPTrainNinit','GPTrainNinitFinal', ...
    ...
    'ActiveImportanceSamplingVPSamples','ActiveImportanceSamplingBoxSamples','ActiveImportanceSamplingMCMCSamples' ...
    'ActiveSearchBound','IntegrateGPMean','GPLengthMeanPrior' ...
    };
