...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','SGDStepSize','RetryMaxFunEvals','SearchAcqFcn','ProposalFcn',...
    'NSsearch','NSent','NSentFast','NSentFine','NSentBoost','NSentFastBoost','NSentFineBoost',...
    'NSelbo','ElboStarts','VariableMeans','VariableWeights', ...
    ...
    'Warmup','WarmupOptions','StopWarmupThresh','WarmupKeepThreshold','SearchCMAESVPInit','SearchCMAESbest','SearchMaxFunEvals','TolStableWarmup','MomentsRunWeight', ...
    'ELCBOmidpoint','GPRetrainThreshold','NSelboIncr','TolImprovement','ELCBOImproWeight', ...
    'GPSampleThin','GPSampleWidths','HypRunWeight','WeightedHypCov','TolCovWeight','GPTolOpt','GPTolOptMCMC', ...
    ...
    'ActiveVariationalSamples','ActiveSampleFullUpdate','FixedMaxMeanGP','GPTrainNinit','GPTrainNinitFinal', ...
    'DetEntropyAlpha','UpdateRandomAlpha','VariationalInitRepo','AdaptiveEntropyAlpha','MaxIterStochastic', ...
    'StopWarmupReliability' ...
    };
