...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','SGDStepSize','RetryMaxFunEvals','SearchAcqFcn','ProposalFcn',...
    ...
    'CacheSize','CacheFrac','TolFunStochastic', ...
    ...
    'ActiveImportanceSamplingVPSamples','ActiveImportanceSamplingBoxSamples','ActiveImportanceSamplingMCMCThin', ...
    'ActiveSearchBound','GPLengthPriorMean','GPLengthPriorStd','TolGPNoise', ...
    ...
    'WarpTolImprovement','WarpUndoCheck','WarpTolSDMultiplier','WarpTolSDBase' ...
