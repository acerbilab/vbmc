...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','SGDStepSize','RetryMaxFunEvals','SearchAcqFcn','ProposalFcn',...
    ...
    'Warmup','WarmupOptions','StopWarmupThresh','WarmupKeepThreshold','SearchCMAES','SearchCMAESVPInit','SearchCMAESbest','SearchMaxFunEvals','TolStableWarmup','MomentsRunWeight', ...
