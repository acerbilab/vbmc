...
defopts.NSentActive        = '@(K) 20*K         % Total samples for Monte Carlo approx. of the entropy (active sampling)';
...
defopts.WarmupKeepThresholdFalseAlarm = '50*(nvars+2) % Max log-likelihood difference for points kept after a false-alarm warmup stop';
