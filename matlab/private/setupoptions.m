...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','AcqFcn','SearchAcqFcn','Nacq','ProposalFcn',...
    'NSsearch','NSent','NSentFast','NSentFine','NSelbo','ElboStarts', ...
    'NSgpMax','StopGPSampling','TolGPVar','QuadraticMean','Kfun','KfunMax','Kwarmup','AdaptiveK',...
    ...
    'NoiseObj','CacheSize','CacheFrac','TolFunAdam' ...
    'TolSD','TolsKL','TolStableIters','TolStableFunEvals',...
    ...
    'GPSampleThin','GPSampleWidths','HypRunWeight','WeightedHypCov', ...
    'CovSampleThresh','AltMCEntropy' ...
    };
