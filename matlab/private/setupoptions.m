...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','AcqFcn','SearchAcqFcn','Nacq','ProposalFcn',...
    ...
    'NSgpMax','StableGPSampling','StableGPSamples','TolGPVar','Kfun','KfunMax','Kwarmup','AdaptiveK',...
    ...
    'TolSD','TolsKL','TolStableIters','TolStableExceptions',...
