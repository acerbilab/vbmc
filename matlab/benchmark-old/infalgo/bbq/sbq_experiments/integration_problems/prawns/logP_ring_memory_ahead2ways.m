function logP = logP_ring_memory_ahead2ways(theta, direction, R, K, p_pulse, decay, q)
...
if iscell(theta)
    logP = 0;
    for i = 1:numel(theta)
        logP = logP + logP_ring_memory_ahead2ways(theta{i}, direction{i}, R, K,p_pulse, decay, q);
    end
else
