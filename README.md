...
**News:** 
- **New paper accepted (Sep/25/2020)** The "Variational Bayesian Monte Carlo with Noisy likelihood" paper [[2](#references)] has been accepted at *NeurIPS* 2020! This is the second VBMC paper at *NeurIPS*. The submitted version of the manuscript is available [on arXiv](https://arxiv.org/abs/2006.08655); a revised version will be uploaded soon.
