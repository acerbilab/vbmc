...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','AcqFcn','SearchAcqFcn','Nacq','ProposalFcn',...
    'NSsearch','NSent','NSentFast','NSentFine','NSelbo','ElboStarts','VariableWeights', ...
    'NSgpMax','StableGPSampling','StableGPSamples','TolGPVar','KfunMax','Kwarmup','AdaptiveK',...
    'HPDFrac', 'WarpRotoScaling', 'WarpNonlinear', 'WarpEpoch', 'WarpCovReg', 'WarpMinFun', 'WarpNonlinearEpoch', 'WarpNonlinearMinFun', ...
    'ELCBOWeight','TolLength','Fvals','OptimToolbox', ...
    'NoiseObj','CacheSize','CacheFrac','TolFunStochastic' ...
    'TolSD','TolsKL','TolStableIters','TolStableEntropyIters','TolStableExceptions',...
    'KLgauss','TrueMean','TrueCov',...
    'MinFunEvals','MinIter','HeavyTailSearchFrac','MVNSearchFrac','SearchSampleGP' ...
    'AlwaysRefitVarPost','VarParamsBack','Plot' ...
    'Warmup','StopWarmupThresh','WarmupKeepThreshold','SearchCMAES','TolStableWarmup','MomentsRunWeight', ...
    ...
    'Portfolio','HedgeGamma','HedgeBeta','HedgeDecay','HedgeMax','SkipActiveSamplingAfterWarmup',...
    'AnnealedGPMean','FeatureTest','SearchCacheFrac'
    };
