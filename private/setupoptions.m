...
evalfields = {'MaxFunEvals','MaxIter','FunEvalStart','FunEvalsPerIter','SearchAcqFcn','ProposalFcn',...
    ...
    'MinFunEvals','MinIter','HeavyTailSearchFrac','MVNSearchFrac', ...
    ...
    'SkipActiveSamplingAfterWarmup','AnnealedGPMean','ConstrainedGPMean','FeatureTest','SearchCacheFrac',...
    'VarActiveSample'
    };
