function acq = vbmc_acqfvreg(Xs,vp,gp,optimState,Nacq,transpose_flag)
%VBMC_ACQFVREG Acquisition function via weighted proposal uncertainty search.
...
z = optimState.ymax;
acq = -vtot .* exp(fbar + 0.5*vtot - z) .* p;
